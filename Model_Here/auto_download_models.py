...
download_model_if_not_exists('trituenhantaoio/bert-base-vietnamese-uncased', './Model_Here/KeyPhraseModel/bert-base-uncased')
download_model_if_not_exists('vinhnado/bert-bilstm-crf-keyphrase', './Model_Here/KeyPhraseModel/BERT-BILSTM-CRF')
